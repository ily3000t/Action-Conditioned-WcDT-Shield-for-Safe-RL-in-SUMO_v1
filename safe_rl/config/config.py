...
class Stage1CollectionConfig:
    ...
    probe_pair_target_risk_source: str = "raw_proxy_risk"
    probe_calibrated_collision_weight: float = 3.0
    probe_calibrated_ttc_trigger_weight: float = 1.2
    probe_calibrated_lane_conflict_weight: float = 0.8
    probe_calibrated_structural_weight: float = 1.8
    probe_calibrated_teleport_weight: float = 2.0
    probe_calibrated_distance_weight: float = 1.0
    probe_calibrated_ttc_continuous_weight: float = 1.0
    probe_trusted_exclude_structural_dominant: bool = False
    probe_pair_stratified_keep_enabled: bool = False
    probe_pair_stratified_bins: int = 16
    probe_pair_keep_per_risk_bin: int = 32
    probe_pair_keep_per_gap_bin: int = 32
    probe_pair_min_total_per_active_bin: int = 16
    stage1_distribution_health_bins: int = 16
    stage1_distribution_healthy_pair_all_effective_min: float = 8.0
    stage1_distribution_healthy_pair_trusted_effective_min: float = 7.0
    stage1_distribution_healthy_candidate_effective_min: float = 3.0
    stage1_distribution_degraded_pair_all_effective_min: float = 6.0
    stage1_distribution_degraded_pair_trusted_effective_min: float = 5.0
    stage1_distribution_degraded_candidate_effective_min: float = 2.0
    stage1_distribution_high_bin_saturation_threshold: float = 0.85
    ...
    scene_sanity_roi_x_min: float = 320.0
    scene_sanity_roi_x_max: float = 420.0
    scene_sanity_roi_y_min: float = -12.0
    scene_sanity_roi_y_max: float = 16.0
...
class WorldModelConfig:
    ...
    pair_ft_stage1_tail_acceptance_enabled: bool = True
    pair_ft_stage1_tail_acceptance_acc_tolerance: float = 0.01
    ...
    pair_ft_stage1_phaseb_anticollapse_weight: float = 0.0
    pair_ft_stage1_phaseb_score_range_floor: float = 0.02
    ...
    pair_ft_gate_eval_uses_gate_score: bool = False
    pair_ft_gate_softbin_loss_weight: float = 0.0
    pair_ft_gate_softbin_num_bins: int = 16
    pair_ft_gate_softbin_temperature: float = 80.0
    pair_ft_gate_softbin_apply_trusted_only: bool = True
    pair_ft_gate_resolution_loss_weight: float = 0.0
    pair_ft_gate_ranking_anchor_weight: float = 0.0
    pair_ft_gate_ranking_anchor_apply_trusted_only: bool = True
    pair_ft_gate_bin_count: int = 16
    pair_ft_gate_bin_score_mode: str = "expectation"
    pair_ft_gate_bin_ce_loss_weight: float = 0.0
    pair_ft_gate_bin_occupancy_loss_weight: float = 0.0
    pair_ft_gate_bin_apply_trusted_only: bool = True
    pair_ft_gate_bin_target_source: str = "target_risk"
