...
class SafeDrivingEnv(BaseEnv):
    ...
    def step(self, action: int):
        ...
        info = {
            ...
            "raw_threshold_used": float(decision.meta.get("raw_threshold_used", 0.0)),
            "block_trigger": str(decision.meta.get("block_trigger", "")),
            "raw_vs_threshold_margin": float(decision.meta.get("raw_vs_threshold_margin", 0.0)),
            "raw_uncertainty": float(decision.meta.get("raw_action_uncertainty", 0.0)),
            "final_uncertainty": float(decision.meta.get("final_action_uncertainty", 0.0)),
            "uncertainty_threshold_used": float(decision.meta.get("uncertainty_threshold_used", 0.0)),
            "raw_uncertainty_vs_threshold_margin": float(decision.meta.get("raw_uncertainty_vs_threshold_margin", 0.0)),
            "best_candidate_action": int(decision.meta.get("best_candidate_action", -1)),
            "best_candidate_fine_risk": float(decision.meta.get("best_candidate_fine_risk", decision.risk_raw)),
            "raw_action_fine_risk": float(decision.meta.get("raw_action_fine_risk", decision.risk_raw)),
            "best_margin": float(decision.meta.get("best_margin", 0.0)),
            "no_safe_candidate": bool(decision.meta.get("no_safe_candidate", False)),
            "raw_already_best": bool(decision.meta.get("raw_already_best", False)),
            "primary_nonreplacement_reason": str(decision.meta.get("primary_nonreplacement_reason", "")),
