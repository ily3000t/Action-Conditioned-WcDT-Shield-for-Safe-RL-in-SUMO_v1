...
def test_stage2_report_includes_pair_finetune_metadata(monkeypatch):
    ...
    def _fake_train_models(*args, stage5_pair_samples=None, stage4_pair_samples=None, **kwargs):
        ...
        return _DummyPredictor(), _DummyPredictor(), {
            ...
            "world_pair_ft": {
                ...
                "epoch_metrics": [
                    {
                        ...
                        "stage1_probe_resolution_loss": 0.0,
                        "stage1_probe_active_pair_count": 0.0,
                        "stage1_probe_active_pair_fraction": 0.0,
                        "stage1_probe_score_gap_mean": 0.0,
                        "stage1_probe_score_gap_p50": 0.0,
                        "stage1_probe_score_gap_p90": 0.0,
                        "stage1_probe_margin_mean": 0.0,
                        "stage1_probe_margin_p50": 0.0,
                        "stage1_probe_margin_p90": 0.0,
                        "stage1_probe_pred_gap_to_margin_ratio_mean": 0.0,
                        ...
                        "stage1_tail_score_range_q90": 0.0,
                    ...
                    },
                    {
                        ...
                        "stage4_aux_score_gap_mean": 0.022,
                        "stage4_aux_score_gap_p50": 0.021,
                        "stage4_aux_score_gap_p90": 0.028,
                        "stage4_aux_resolution_loss": 0.03,
                        "stage4_aux_below_score_margin_count": 1.0,
                        "stage4_aux_below_score_margin_fraction": 0.5,
                        "stage1_probe_resolution_loss": 0.01,
                        "stage1_probe_active_pair_count": 3.0,
                        "stage1_probe_active_pair_fraction": 0.3,
                        "stage1_probe_score_gap_mean": 0.014,
                        "stage1_probe_score_gap_p50": 0.013,
                        "stage1_probe_score_gap_p90": 0.020,
                        "stage1_probe_margin_mean": 0.019,
                        "stage1_probe_margin_p50": 0.018,
                        "stage1_probe_margin_p90": 0.021,
                        "stage1_probe_pred_gap_to_margin_ratio_mean": 0.73,
                        ...
                        "stage15_gate_ranking_anchor_loss": 0.012,
                        ...
                        "stage1_tail_score_range_q90": 0.34,
                        "stage1_tail_score_range": 0.03,
                    },
                ],
                ...
                "stage1_resolution_mode": "adaptive",
                ...
                "stage15_gate_head": {
                    ...
                    "ranking_anchor_weight": 0.0,
                    "ranking_anchor_apply_trusted_only": True,
                    "scale": 1.02,
                    "bias": 0.001,
                ...
                "stage1_tail_anticollapse_loss": 0.004,
                "stage1_tail_score_range_q10_q90": {"q10": 0.31, "q90": 0.34, "range": 0.03},
    ...
    assert report["world_pair_ft_source_mix"]["phase_b_stage1_anticollapse_weight_effective"] == pytest.approx(0.003)
    ...
    assert report["world_pair_ft_source_mix"]["stage1_tail_score_range_floor_effective"] == pytest.approx(0.02)
    ...
    assert "stage4_aux_score_gap_mean" in world_epoch_metrics[0]
    assert "stage4_aux_score_gap_p50" in world_epoch_metrics[0]
    assert "stage4_aux_score_gap_p90" in world_epoch_metrics[0]
    assert "stage4_aux_below_score_margin_fraction" in world_epoch_metrics[0]
    assert "stage1_probe_resolution_loss" in world_epoch_metrics[0]
    assert "stage1_probe_active_pair_count" in world_epoch_metrics[0]
    assert "stage1_probe_score_gap_mean" in world_epoch_metrics[0]
    assert "stage1_probe_below_score_margin_fraction" in world_epoch_metrics[0]
    assert "stage1_probe_margin_mean" in world_epoch_metrics[0]
    assert "stage1_probe_margin_p50" in world_epoch_metrics[0]
    ...
    assert "stage1_tail_score_range_q90" in world_epoch_metrics[0]
    assert "stage1_tail_score_range" in world_epoch_metrics[0]
    ...
    assert world_epoch_metrics[0]["stage1_probe_margin_mean"] == pytest.approx(0.0)
    ...
    assert world_epoch_metrics[1]["phase_b_stage1_anticollapse_loss"] == pytest.approx(0.002)
    ...
    assert world_epoch_metrics[1]["stage1_tail_score_range_q90"] == pytest.approx(0.34)
    assert world_epoch_metrics[1]["stage1_tail_score_range"] == pytest.approx(0.03)
    ...
    assert report["pair_finetune_metrics"]["world"]["stage1_resolution_mode"] == "adaptive"
    assert report["pair_finetune_metrics"]["world"]["pair_ft_stage1_resolution_min_score_gap"] == pytest.approx(0.015)
    ...
    assert report["pair_finetune_metrics"]["world"]["phase_b_stage1_anticollapse_steps"] == 2
    assert report["pair_finetune_metrics"]["world"]["phase_b_stage1_anticollapse_active_pair_count"] == 6
    assert report["pair_finetune_metrics"]["world"]["phase_b_stage1_anticollapse_loss"] == pytest.approx(0.002)
    assert report["pair_finetune_metrics"]["world"]["phase_b_stage1_score_range_q10_q90"] == {
        "q10": pytest.approx(0.30),
    ...
    assert report["pair_finetune_metrics"]["world"]["stage1_tail_anticollapse_loss"] == pytest.approx(0.004)
    assert report["pair_finetune_metrics"]["world"]["stage1_tail_score_range_q10_q90"] == {
        "q10": pytest.approx(0.31),
        "q90": pytest.approx(0.34),
        "range": pytest.approx(0.03),
    }
    ...
    assert report["pair_finetune_metrics"]["world"]["stage15_gate_head"]["hidden_dim"] == 128
    assert report["pair_finetune_metrics"]["world"]["stage15_gate_head"]["dropout"] == pytest.approx(0.0)
    ...
    assert report["pair_finetune_metrics"]["world"]["stage15_gate_head"]["ranking_anchor_weight"] == pytest.approx(0.0)
    assert (
        report["pair_finetune_metrics"]["world"]["stage15_gate_head"]["ranking_anchor_apply_trusted_only"]
        is True
    )
    ...
    assert any("stage15_gate_ranking_anchor_loss" in item for item in report["pair_finetune_metrics"]["world"]["epoch_metrics"])
    ...
    assert report["pair_finetune_metrics"]["world"]["epoch_metrics"][1]["stage15_gate_ranking_anchor_loss"] == pytest.approx(0.012)
